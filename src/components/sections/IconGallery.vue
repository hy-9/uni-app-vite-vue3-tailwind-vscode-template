...
<template>
	...
	>
		...
		<view
			class="mt-4 grid grid-cols-3 gap-3 rounded-[28rpx] border border-slate-100 bg-slate-50/80 p-3 text-center sm:grid-cols-4 md:grid-cols-6"
		>
			<view
				v-for="(icon, index) in iconList"
				:key="icon"
				class="w-full rounded-2xl border border-white/80 bg-white py-3 text-slate-700 shadow-[0_20px_40px_rgba(15,23,42,0.1)]"
