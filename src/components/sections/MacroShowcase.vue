...
<template>
	...
	>
		...
		<view class="mt-4 space-y-4">
			...
			<view
				class="rounded-[24rpx] border border-dashed border-slate-200 bg-slate-50/80 p-4 text-sm text-slate-600"
			>
				...
				<view
					class="rounded-xl px-3 py-2 text-white ifdef-[MP-WEIXIN]:bg-blue-500 ifndef-[MP-WEIXIN]:bg-red-500"
				>
					微信小程序为蓝色，不是微信小程序为红色
				</view>

				<view
					class="mt-3 rounded-xl px-3 py-2 text-white wx:bg-blue-500 -wx:bg-red-500"
				>
				...
				<view
					class="mt-3 rounded-xl bg-white/60 px-3 py-2 text-slate-700"
				>
		...
		<view
			class="mt-4 rounded-[24rpx] border border-slate-200/80 bg-white/60 p-4 shadow-inner"
		>
			<view class="text-sm font-semibold text-slate-700"> 更多文档 </view>
			<view class="text-xs text-slate-500"> 点击复制链接 </view>
